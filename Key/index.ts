...
export type Key = userwidgets.User.Key<userwidgets.User.Key.Creatable.Claims, Roles.Permissions.Weekmeter>
export namespace Key {
	export type Creatable = KeyCreatable
	export const Creatable = KeyCreatable
	export const type: isly.Type<Key> = userwidgets.User.Key.type.create({ permissions: Roles.Permissions.type })
